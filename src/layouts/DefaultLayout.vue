    ...
    <modal :show="modals.login" @close-modal="closeModal">
      ...
      <form action="">
        <div class="mb-4">
          ...
          <div class="form__filed relative">
            <input class="input__field" v-model="formLogin.email" type="email" placeholder="Email">
          </div>
        </div>
        <div class="mb-4">
          <label for="" class="input__label">Password</label>
          <div class="form__filed relative">
            <input class="input__field" v-model="formLogin.password" type="password" placeholder="Password">
          </div>
        </div>
        <div class="mb-4">
